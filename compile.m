...
try % try OpenMP support
    if strcmp(mexext,'mexmaci64')
        eval(['mex CC=''gcc'' CFLAGS=''-U_OPENMP -Dchar16_t=UINT16_T -m64 -fPIC -O3'' -I/usr/include ' WIN32 ' -O cg_glm_get_Beta_ResSS.c utils_uchar.' mexext obj ' utils_short.' mexext obj ...
        ...
        mex CC='gcc' CFLAGS='-U_OPENMP -Dchar16_t=UINT16_T -m64 -fPIC -O3' -I/usr/include -O tfceMex.c
        movefile(['tfceMex.' mexext], ['tfceMex_noopenmp.' mexext],'f');
        mex CC='gcc' CFLAGS='-fopenmp -Dchar16_t=UINT16_T -m64 -fPIC -O3' -O /usr/local/lib/x86_64/libgomp.a tfceMex.c         
        eval(['mex CC=''gcc'' CFLAGS=''-fopenmp -Dchar16_t=UINT16_T -m64 -fPIC -O3'' -I/usr/include ' WIN32 ' -O /usr/local/lib/x86_64/libgomp.a cg_glm_get_Beta_ResSS.c utils_uchar.' mexext obj ' utils_short.' mexext obj ...
            ' utils_int.' mexext obj ' utils_schar.' mexext obj ' utils_ushort.' mexext obj ' utils_uint.' mexext obj ...
            ' utils_float.' mexext obj ' utils_double.' mexext obj ' utils_short_s.' mexext obj ' utils_int_s.' mexext obj ...
            ' utils_ushort_s.' mexext obj ' utils_uint_s.' mexext obj ' utils_float_s.' mexext obj ' utils_double_s.' mexext obj ...
            ' spm_make_lookup.' mexext obj ' spm_getdata.' mexext obj ' spm_vol_access.' mexext obj ' spm_mapping.' mexext obj]);
    ...
    mex CC='gcc' CFLAGS='-fPIC -O3' -O tfceMex.c 
end

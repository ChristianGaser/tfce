...
mex CC='gcc-4.4' -I/usr/include -O -c spm_vol_utils.c -DSPM_SIGNED_INT 
movefile(['spm_vol_utils' obj], ['utils_int.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_vol_utils.c -DSPM_SIGNED_CHAR 
movefile(['spm_vol_utils' obj], ['utils_schar.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_vol_utils.c -DSPM_UNSIGNED_SHORT 
movefile(['spm_vol_utils' obj], ['utils_ushort.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_vol_utils.c -DSPM_UNSIGNED_INT 
movefile(['spm_vol_utils' obj], ['utils_uint.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_vol_utils.c -DSPM_FLOAT 
movefile(['spm_vol_utils' obj], ['utils_float.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_vol_utils.c -DSPM_DOUBLE 
movefile(['spm_vol_utils' obj], ['utils_double.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_vol_utils.c -DSPM_SIGNED_SHORT -DSPM_BYTESWAP 
movefile(['spm_vol_utils' obj], ['utils_short_s.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_vol_utils.c -DSPM_SIGNED_INT -DSPM_BYTESWAP 
movefile(['spm_vol_utils' obj], ['utils_int_s.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_vol_utils.c -DSPM_UNSIGNED_SHORT -DSPM_BYTESWAP 
movefile(['spm_vol_utils' obj], ['utils_ushort_s.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_vol_utils.c -DSPM_UNSIGNED_INT -DSPM_BYTESWAP 
movefile(['spm_vol_utils' obj], ['utils_uint_s.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_vol_utils.c -DSPM_FLOAT -DSPM_BYTESWAP 
movefile(['spm_vol_utils' obj], ['utils_float_s.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_vol_utils.c -DSPM_DOUBLE -DSPM_BYTESWAP 
movefile(['spm_vol_utils' obj], ['utils_double_s.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_make_lookup.c 
movefile(['spm_make_lookup' obj], ['spm_make_lookup.' mexext obj],'f');
mex CC='gcc-4.4' -I/usr/include -O -c spm_getdata.c 
movefile(['spm_getdata' obj], ['spm_getdata.' mexext obj],'f');
eval(['mex CC=''gcc-4.4'' -I/usr/include ' WIN32 ' -O -c spm_vol_access.c']) 
movefile(['spm_vol_access' obj], ['spm_vol_access.' mexext obj],'f');
eval(['mex CC=''gcc-4.4'' -I/usr/include ' WIN32 ' -O -c spm_mapping.c']) 
...
movefile(['spm_vol_access' obj], ['spm_vol_access.' mexext obj],'f');
eval(['mex -I/usr/include ' WIN32 ' -O -c spm_mapping.c']) 
movefile(['spm_mapping' obj], ['spm_mapping.' mexext obj],'f');

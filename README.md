...
An extension to [SPM12](http://www.fil.ion.ucl.ac.uk/spm/software/spm12/) providing non-parametric
permutation inference with threshold-free cluster enhancement (TFCE), for 3D volume and surface data.
...
- [Features](#features)
  - [Inference](#inference)
  - [Designs it understands](#designs-it-understands)
  - [Fewer permutations](#fewer-permutations)
  - [Faster permutations](#faster-permutations)
